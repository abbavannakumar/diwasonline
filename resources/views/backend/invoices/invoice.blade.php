	...
	<div>
		...
		<div style="background: #eceff4;padding: 1rem;">
			...
			<table>
				...
				@if($order->smart_card_number)
<tr>
    <td class="gry-color small"></td>
    <td class="text-right small">
        <span class="gry-color small">{{ translate('Smart Card Number') }}:</span>
        <span class="strong text-success">{{ $order->smart_card_number }}</span>
    </td>
</tr>
@endif
				<tr>
		                ...
		                @if ($orderDetail->product != null)
							<tr class="">
								<td>
                                    ...
                                    @if($orderDetail->card_number != null)<br/><b>Card Number ::  {{ $orderDetail->card_number }} </b>@endif
                                    <br>
                                    <small>
                                        @php
